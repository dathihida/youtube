							...
							<tbody>
								<c:forEach items="${videos}" var="item">
									<tr>
										...
										<td>
											<a href="<c:url value='/admin/video?action=edit&href=${item.href}'/>" type="button" class="btn btn-block btn-info">Edit</a>
											<button type="button" onClick="deleteVideo('${item.href}')" class="btn btn-block btn-danger">Delete</button>				
										</td>
									</tr>
								</c:forEach>
							</tbody>
