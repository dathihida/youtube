					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<a href="#" class="nav-link active">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a href="<c:url value='/admin/user?action=edit'/>"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>New or edit</p>
								</a></li>
							</ul>
							...
							<tbody>
								<c:forEach items="${videos}" var="item">
									<tr>
										...
										<td>
											<a href="<c:url value='/admin/user?action=edit&username=${item.username}'/>" type="button" class="btn btn-block btn-info">Edit</a>
											<button type="button" onClick="deleteUser('${item.username}')" class="btn btn-block btn-danger">Delete</button>				
										</td>
									</tr>
								</c:forEach>
							</tbody>
...
function deleteUser(username) {
	$.ajax({
		url: '/asm_java4/admin/user?action=delete&username=' +username	
	}).then(function(data) {
