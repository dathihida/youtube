					...
					<form action="${url}/index" method="post" class="mx-auto">
						...
						<div class="mb-3 mt-3">
							<label for="id" class="form-label">Username:</label>
							 <input type="id" class="form-control" id="username" placeholder="Enter username" name="username"
								value="${form.username}">
						</div>
						<div class="mb-3">
						...
						<div class="form-check mb-3">
							...
							<input ${form.isAdmin?'checked':''} class="form-check-input" type="radio"
								name="admin" value="true"> Admin
							</label> <label class="form-check-label1"> <input
								${form.isAdmin?'':'checked'} class="form-check-input" type="radio"
								name="admin" value="false"> User
							</label>
						</div>
						<button class="btn" formaction="${url}/update">Update</button>
						<button class="btn" formaction="${url}/delete">Delete</button>
							...
							<tbody>
								<c:forEach items="${items}" var="item">
									<tr>
										...
										<td><a href="/asm_java4/admin/edit/${item.username}">Edit</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
