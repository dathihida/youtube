...
<body>
	...
	<!-- sidebar -->
	<div class="container">
		<h2 style="padding-top: 5rem; padding-left: 12rem;">List Favorite</h2>
		<div class="row" style="padding-top: 1rem; padding-left: 12rem;">
			...
			<c:forEach items="${videos}" var="video">
				<div class="col-lg-4 mb-5">
					...
					<div class="d-flex justify-content-between tm-text-gray">
						<span class="tm-text-gray-light">${video.shares }Shares</span> <span>${video.views }Views</span>
					</div>
				</div>
			</c:forEach>
