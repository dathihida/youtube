    ...
    <div class="container-fluid tm-mt-60" >
        <div class="row tm-mb-50">
            <div class="col-lg-12 col-12 mb-5">
               <center><h2 class="tm-text-primary mb-5" style="padding-top: 9rem">Register</h2></center>
                <form id="register-form" action="register" method="POST" class="tm-contact-form mx-auto" style="width: 25%">
